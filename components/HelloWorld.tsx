...
const QUICKNODE_HTTP_ENDPOINT = "https://dimensional-orbital-theorem.matic-testnet.quiknode.pro/e7bb0adb8832096adfa7dd828ac8e4299faa3f23/"
  ...
  useEffect(() => {
    const fetchMessage = async () => {
      if (typeof window.ethereum !== 'undefined') {
        ...
        const contractInstance = new ethers.Contract(contractAddress, myContractAbi, provider);
        try {
